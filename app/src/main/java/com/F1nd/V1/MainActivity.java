...
public class MainActivity extends AppCompatActivity {
    ...
    int[] colors = { Color.rgb(189, 47, 71), Color.rgb(228, 101, 92), Color.rgb(241, 177, 79),
            Color.rgb(161, 204, 89), Color.rgb(33, 197, 163), Color.rgb(58, 158, 173), Color.rgb(92, 101, 100),Color.rgb(10, 92, 30),Color.rgb(10, 50, 50)};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        pieChart.setCenterText("Click on Start F1nd");
        ...
        if(isMyServiceRunning(MyService.class)) {
            Toast.makeText(getBaseContext(), "F1nd service is already running", Toast.LENGTH_SHORT).show();
            ss.setText("STOP F1nd");
            ss.setBackgroundColor(Color.RED);
            ss.setTextColor(Color.WHITE);
        }
        else {
            Toast.makeText(getBaseContext(), "Starting F1nd service", Toast.LENGTH_SHORT).show();
